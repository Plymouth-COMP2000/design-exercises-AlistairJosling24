    ...
    class listener2 implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (success) {
                ...
                String message = "Your booking for " + date + " at " + time + " for " + size + " people has been confirmed!";
                boolean notifSuccess = db.addnotification(username, message);
                if(notifSuccess) {
                    Toast.makeText(customer_make_a_booking.this, "\"Your booking for " + date + " at " + time + " for " + size + " people has been confirmed!", Toast.LENGTH_LONG).show();
                } else {
